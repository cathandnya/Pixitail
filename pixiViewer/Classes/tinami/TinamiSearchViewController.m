...
- (NSString *) urlString {
	return [NSString stringWithFormat:@"http://api.tinami.com/content/search?api_key=4baafbbe9fbd0&%@&%@&%@&page=%d", [NSString stringWithFormat:[self selectedScope], encodeURIComponent(self.searchTerm)], [self selectedType], [self selectedSort], loadedPage_ + 1];
}
